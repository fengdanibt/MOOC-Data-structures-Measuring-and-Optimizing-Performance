...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String text_src = getStringFromFile(textfile, numToCheck);

			BasicDocument basicDocument = new BasicDocument(text_src);
			...
			EfficientDocument efficientDocument = new EfficientDocument(text_src);
			startTime =  System.nanoTime();
			for (int i = 0; i < trials; i++)
